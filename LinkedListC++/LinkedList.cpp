//Kevin Nguyen
//kudos to Mr. Paul, Mr. Thompson, and Mr. Scott for teaching me how data structures work (such as LinkedLists) in C++ during 2015
...
//Push node onto list
void LinkedList::addNode(int newData) { //addNode(int addData) {
	//local declarations
...
void LinkedList::removeNode(int badData) {
	/* local declarations */
...
//finds item in list
int LinkedList::findData(int tgtData) {
	//local declaration
